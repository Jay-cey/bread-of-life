  ...
  return (
    <div className="min-h-screen bg-[var(--background)] pb-32">
      ...
      <header className="relative w-full h-[60vh] min-h-[400px] flex items-end pb-16 px-6 pt-40">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-t from-[var(--background)] via-[var(--background)]/80 to-[var(--background)]/20" />
        
        <div className="relative z-10 max-w-3xl mx-auto w-full">
          <Link
            href="/journal"
            className="inline-flex items-center gap-2 text-[var(--primary)] opacity-60 hover:opacity-100 hover:text-[var(--accent)] font-sans text-xs uppercase tracking-widest font-bold transition-all mb-10"
          >
          ...
          <div className="flex items-center gap-4 mb-6">
            <span className="bg-[var(--accent)] text-[var(--background)] px-3 py-1 text-[10px] uppercase tracking-widest rounded-full font-bold shadow-sm">
              {article.category}
            </span>
            <span className="font-sans text-xs text-[var(--primary)] opacity-70 uppercase tracking-widest">
              {article.readTime}
            </span>
          </div>

          <h1 className="font-serif text-5xl md:text-6xl text-[var(--primary)] mb-6 leading-[1.1]">
            {article.title}
          </h1>
